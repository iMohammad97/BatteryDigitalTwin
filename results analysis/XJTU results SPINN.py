...
class Results:
    def __init__(self,root='../results of reviewer/SPINN/XJTU results/'):
        self.root = root
    ...
    def parser_label(self):
        ...
        # print("split_point:", len(split_point))
        ...
        # print("local_minima:", len(local_minima))
    ...
    def get_test_results(self,train=0,test=1,e=1):
        ...
        # print(len(results_dict['pred_label']))
        # print(len(results_dict['true_label']))
        # print(len(results_dict['MAE']))
        # print(len(results_dict['MAPE']))
        # print(len(results_dict['RMSE']))
        # print(len(results_dict['channel']))
        return results_dict
...
if __name__ == '__main__':
    root = 'results of reviewer/SPINN/XJTU results/'
    writer = pd.ExcelWriter('results of reviewer/SPINN/XJTU_results.xlsx')

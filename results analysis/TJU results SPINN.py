...
class Results:
    def __init__(self,root='../results/SPINN/TJU results/',gap=0.07):
        self.root = root
...
if __name__ == '__main__':
    ...
    root = 'results of reviewer/SPINN/TJU results/'
    writer = pd.ExcelWriter('results of reviewer/SPINN/TJU_results.xlsx')
    batch = 0

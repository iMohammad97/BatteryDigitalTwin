...
class Results:
    def __init__(self,root='../results of reviewer/PINN/XJTU results/'):
        self.root = root
    ...
    def get_test_results(self,train=0,test=1,e=1):
        ...
        # print((results_dict['MAPE']))
        # print(len(results_dict['RMSE']))
        # print((results_dict['channel']))
        # print(results_dict)
        return results_dict
...
if __name__ == '__main__':
    root = 'results of reviewer/PINN/XJTU results/'
    writer = pd.ExcelWriter('results of reviewer/PINN/XJTU_results.xlsx')
